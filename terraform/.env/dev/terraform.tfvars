...
vpc_public_subnets_names   = ["poppma-dev-pub-1a", "poppma-dev-pub-1c"]
vpc_private_subnets        = ["10.2.10.0/24", "10.2.11.0/24"]
vpc_private_subnets_names  = ["poppma-dev-pri-1a", "poppma-dev-pri-1c"]
vpc_database_subnets       = ["10.2.20.0/24", "10.2.21.0/24"]
vpc_database_subnets_names = ["poppma-dev-db-1a", "poppma-dev-db-1c"]
